...
num_fold = 5; num_metric = 4; num_method = 12;
...
%     tic; percent = [0.5,0.8,0.8]; num_ite = 20; model = @CCridge;
...
%     Results(2:end,i,3) = [ExactM,HamS,MacroF1,MicroF1];
    ...
    tic; num_cluster = 2; model = @CCridge;
...
%     tic; num_cluster = 20; model = @EnMLC;
...
ignore = [1:3,5:7,9:10,12];  Results(:,:,ignore) = [];
...
str2 = {'BR','CC','EnMLC','CBMLC','CLMLC','BRPCA','BROPLS','BRHSL','BRSVM','CCSVM','CPLST','PLST'}; 
str2(ignore) = [];
